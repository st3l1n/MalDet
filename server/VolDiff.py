...
plugins_to_run = ["handles", "psxview", "netscan", "iehistory", "getsids", "pslist", "psscan", "cmdline", "consoles",
                  ...
                  "threads", "malfind", "procdump", "idt", "gdt", "driverirp", "deskscan", "gditimers",
                  "ssdt"]
...
keylogger_imports = "GetKeyboardState|GetKeyState|GetAsyncKeyState|SetWindowsHookEx|ToUnicodeEx|GetClipboardData|" \
                    "GetKeyboardLayout|GetKeyNameTextW"
password_extract_imports = "SamLookupDomainInSamServer|NlpGetPrimaryCredential|LsaEnumerateLogonSessions|" \
                           "SamOpenDomain|SamOpenUser|SamGetPrivateData|SamConnect|SamRidToSid|PowerCreateRequest|" \
                           "SeDebugPrivilege|SystemFunction006|SystemFunction040"
clipboard_imports = "OpenClipboard|GetClipboardData"
process_injection_imports = "VirtualAlloc|VirtualAllocEx|AllocateVirtualMemory|VirtualProtectEx|ProtectVirtualMemory|" \
                            "CreateProcess|LoadLibrary|LdrLoadDll|" \
                            "CreateToolhelp32Snapshot|QuerySystemInformation|EnumProcesses|WriteProcessMemory|" \
                            "WriteVirtualMemory|CreateRemoteThread|ResumeThread|" \
                            "SetThreadContext|SetContextThread|QueueUserAPC|QueueApcThread|WinExec|FindResource|" \
                            "SeDebugPrivilege|VirtualFree"
uac_bypass_imports = "AllocateAndInitializeSid|EqualSid|RtlQueryElevationFlags|" \
                     "GetTokenInformation|GetSidSubAuthority|" \
                     "GetSidSubAuthorityCount|PriviledgeCheck|LookupPrivilegeValueA|LsaEnumerateAccountRights|" \
                     "AdjustTokenPrivileges"
anti_debug_imports = "SetUnhandledExceptionFilter|CheckRemoteDebugger|DebugActiveProcess|FindWindow|GetLastError|" \
                     "GetWindowThreadProcessId|IsDebugged|" \
                     "IsDebuggerPresent|NtCreateThreadEx|NtGlobalFlags|NtSetInformationThread|OutputDebugString|" \
                     "pbIsPresent|Process32First|Process32Next|TerminateProcess|ThreadHideFromDebugger|" \
                     "UnhandledExceptionFilter|ZwQueryInformation|Sleep|GetProcessHeap|NtQueryInformationProcess|" \
                     "GetProcessByName"
web_imports = "InternetReadFile|recvfrom|WSARecv|DeleteUrlCacheEntry|CreateUrlCacheEntry|URLDownloadToFile|" \
              "WSASocket|WSASend|WSARecv|" \
              "WS2_32|InternetOpen|HTTPOpen|HTTPSend|InternetWrite|InternetConnect"
...
registry_uac_bypass_regex = "Software\\Classes\\mscfile\\shell\\\open\\\command|Software\\\Microsoft\\\Windows\\\CurrentVersion\\\App Paths\\\control.exe|Software\\Classes\\exefile\\shell\\\\runas\\command\\isolatedCommand"
...
parent_child = {'services.exe': ["sppsvc.exe", "taskhost.exe", "mscorsvw.exe", "TPAutoConnSvc", "SearchIndexer",
                                 "svchost.exe", "taskhost.exe", "spoolsv.exe"],
                'System': ["smss.exe"], 'csrss.exe': ["conhost.exe"],
                'svchost.exe': ["WmiPrvSE.exe", "audiodg.exe", "taskhostw.exe"],
...
profiles = ["VistaSP0x86", "VistaSP0x64", "VistaSP1x86", "VistaSP1x64", "VistaSP2x86", "VistaSP2x64",
            ...
            "WinXPSP2x86", "WinXPSP1x64", "WinXPSP2x64", "WinXPSP3x86", "Win7SP1x64_24000"]

preferred_profiles = ["Win7SP0x86", "Win7SP0x64", "Win7SP1x86", "Win7SP1x64", "Win7SP1x64_24000"]
...
def print_help():
    ...
    print ("--vt                  use virustotal fora malware scanning")
    print ("\nTested using Volatility 2.6.1 (vol.py) on Windows 7 images.")
    sys.exit()
...
def main():
    ...
    report_name = "/home/cuckoo/MalDet/VolDiff_reports/reports/full" + "/VolDiff_Report_%s.txt" % infected_memory_image.split('/')[-1][9:].split('.')[0]
    ...
    if mode == "dual":
        ...
        # report.write("\nDownload the latest MalDet version from https://github.com/st-elin/MalDet/")
    ...
    new_exe_excluded_regex = "system32|explorer.exe|iexplore.exe|VMware|wininit.exe|winlogon.exe|TrustedInstaller.exe|taskhost.exe|mscorsvw.exe|TPAutoConnect.exe|comctl32.dll|syswow64"
    ...
    ldrmodules_excluded_regex_1 = "System32\\\msxml6r.dll|System32\\\oleaccrc.dll|System32\\\imageres.dll|System32\\\\ntdll.dll|System32\\\winlogon.exe|System32\\\services.exe|System32\\\tquery.dll|System32\\\wevtapi.dll|SysWOW64\\ntdll.dll|SysWOW64\\sechost.dll|sysWOW64\\wbem\\FastProx.dll|sysWOW64\\wbem\\wmiprvse.exe|-secured|-Embedding|syswow64\\ADVAPI32.dll|syswow64\\CFGMGR32.dll|syswow64\\CLBCatQ.DLL|syswow64\\CRYPTBASE.dll|syswow64\\DEVOBJ.dll|syswow64\\GDI32.dll|syswow64\\KERNELBASE.dll|syswow64\\LPK.dll|syswow64\\MSCTF.dll|syswow64\\NSI.dll|syswow64\\OLEAUT32.dll|syswow64\\RPCRT4.dll|syswow64\\SETUPAPI.dll|syswow64\\SHELL32.dll|syswow64\\SHLWAPI.dll|syswow64\\SspiCli.dll|syswow64\\USER32.dll|syswow64\\USERENV.dll|syswow64\\USP10.dll|syswow64\\WININET.dll|syswow64\\WLDAP32.dll|syswow64\\WS2_32.dll|syswow64\\api-ms-win-downlevel-advapi32-l1-1-0.dll|syswow64\\api-ms-win-downlevel-normaliz-l1-1-0.dll|syswow64\\api-ms-win-downlevel-ole32-l1-1-0.dll|syswow64\\api-ms-win-downlevel-shlwapi-l1-1-0.dll|syswow64\\api-ms-win-downlevel-user32-l1-1-0.dll|syswow64\\api-ms-win-downlevel-version-l1-1-0.dll|syswow64\\iertutil.dll|syswow64\\kernel32.dll|syswow64\\msvcrt.dll|syswow64\\normaliz.DLL|syswow64\\ole32.dll|syswow64\\profapi.dll|syswow64\\urlmon.dll|WinSxS"
