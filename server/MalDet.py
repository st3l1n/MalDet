...
# c.execute('''CREATE TABLE MalDet_S
# ([generated_id] INTEGER PRIMARY KEY,
# [filename] text, [filetype] text,
# [type_probability] real, [sha_1] text, 
# [analysis_date] text, [analyzer_ip] text)''')

# c.execute('''CREATE TABLE MalDet_B
# ([generated_id] INTEGER PRIMARY KEY,
# [filename] text, [ssdeep_hash] text,
# [sha1_hash] text, [import_hash] text,
# [result] BLOB, [analysis_date] text, [analyzer_ip] text)''')
