#!/usr/bin/env python
# Made upon VolDiff - malware analysis script by @aim4r
__author__ = 'st-elin'
...
def analyse_registry(pid):
    ...
    registry_analysis_matrix = {"\nCollects information about system": registry_infogathering_regex,
                                ...
                                "\nQueries / trying to bypass uac": registry_uac_bypass_regex,
                                }
...
def main():
    ...
    # CREATE REPORT ================================================================
    report_path = "/home/cuckoo/PycharmProjects/vm_manage/VolDiff/reports/VolDiff_Report_%s.txt" % infected_memory_image.split('/')[-1][9:].split('.')[0]
    print report_path
    ...
    if mode == "dual":
        new_dlls = anomaly_search("dlllist", "C:.*.dll", 'yes', "System32|SySWoW64")
